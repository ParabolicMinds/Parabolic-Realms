...
================
*/
static void GLEWAPIENTRY R_ArrayElementDiscrete( GLint index ) {
...
static int		c_begins;
static void R_DrawStripElements( int numIndexes, const glIndex_t *indexes, void ( GLEWAPIENTRY *element )(GLint) ) {
	int i;
	glIndex_t last[3];
	qboolean even;
