...
#define PRODUCT_NAME			"parabolicrealms"

#define CLIENT_WINDOW_TITLE "Parabolic Realms (MP)"
#define CLIENT_CONSOLE_TITLE "Parabolic Realms Console (MP)"
#define HOMEPATH_NAME_UNIX "parabolicrealms"
#define HOMEPATH_NAME_WIN "Parabolic Realms"
#define HOMEPATH_NAME_MACOSX HOMEPATH_NAME_WIN

#define	BASEGAME "base"
#define OPENJKGAME "Parabolic Realms"
...
#define BUTTON_FORCEGRIP		(1<<6)	//
#define BUTTON_ALT_ATTACK		(1<<7)

#define	BUTTON_ANY				(1<<8)	// any key whatsoever

#define BUTTON_FORCEPOWER		(1<<9)			// use the "active" force power

#define BUTTON_FORCE_LIGHTNING	(1<<10)

#define BUTTON_FORCE_DRAIN		(1<<11)

#define BUTTON_GRAPPLE_HOOK		(1<<12)
