...
if(WIN32)
	include(CPackNSIS)
	set(CPACK_NSIS_DISPLAY_NAME "ParabolicRealms")
	set(CPACK_NSIS_PACKAGE_NAME "ParabolicRealms")
...
set(CPACK_PACKAGE_FILE_NAME "ParaRealms-${CMAKE_SYSTEM_NAME}-${Architecture}")

set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "An improved Jedi Academy")
set(CPACK_PACKAGE_VENDOR "JACoders")
set(CPACK_PACKAGE_INSTALL_DIRECTORY "ParaRealms")
